    ...
    return (
        <section className="p-8 flex items-center text-center flex-col bg-black-grain text-off-white">
            ...
            <div className="font-roboto text-base [&>*]:pb-4">
                ...
                <p>My passive is in UI/UX design, front-end web development and creative coding.</p>
                <p>I&apos;m always curious to learn about new technologies and ways of doing things.</p>
            </div>
        </section>
    )
}